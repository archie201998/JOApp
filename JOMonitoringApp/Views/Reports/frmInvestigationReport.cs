    ...
    public partial class frmInvestigationReport : Form
    {
        ...
        private void LoadReport()
        {
            ...
            try
            {
                ...
                _values += "\n";
                _values += Convert.ToDecimal(dictInvestigation["amount_due"]).ToString("N2") + "\n";
                _values += Convert.ToDecimal(dictInvestigation["adjustment_amount"]).ToString("N2") + "\n";
                ...
                _values += Convert.ToDecimal(dictInvestigation["adjusted_amount"]).ToString("N2") + "\n";
